...
function CreateOrder() {
  ...
  const inputStyle = `mb-5 gap-2 flex flex-col 
      ...
      <Form method="POST" action="/order/new">
        ...
        <div className={inputStyle}>
          ...
          <div className="grow">
            ...
            />
            {formErrors?.phone && (
              <p className="text-s mt-2 rounded-full bg-red-100 p-2 text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className={`${inputStyle} relative`}>
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[5px] top-[5px] z-50 md:right-[6px] md:top-[6spx]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
